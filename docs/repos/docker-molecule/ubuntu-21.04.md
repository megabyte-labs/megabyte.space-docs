...
> </br><h3 align="center">**A Ubuntu 21.04 (i.e. Ubuntu Hirsute Hippo) image with Python 3, systemd, and a non-root sudo user (user and password are both *ansible*) intended to be used by Ansible Molecule tests**</h3></br>
