...
> </br><h3 align="center">**A Ubuntu 18.04 (i.e. Ubuntu Bionic Beaver) image with Python 3, systemd, and a non-root sudo user (user and password are both *ansible*) intended to be used by Ansible Molecule tests**</h3></br>
