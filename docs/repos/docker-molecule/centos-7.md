...
title: CentOS 7
description: A CentOS 7 image with Python 3, systemd, and a non-root sudo user (user and password are both *ansible*) intended to be used by Ansible Molecule tests
editUrl: <https://gitlab.com/megabyte-labs/docker/ansible-molecule/centos-7/blob/master/docs/GUIDE.md>
editApiUrl: <https://github.com/ionic-team/capacitor-plugins/blob/main/docker-molecule/src/definitions.ts>
sidebar\_label: CentOS 7
githubUrl: false
gitlabUrl: false
ansibleGalaxyProjectId: false
packageGroup: false
packageName: '@megabytelabs/docker-ansible-molecule-centos-7'
packageSlug: false
...
<div align="center">
  <center>
    <a href="https://gitlab.com/megabyte-labs/dockerfile/ansible-molecule/centos-7">
      <img width="140" height="140" alt="CentOS 7 logo" src="https://gitlab.com/megabyte-labs/dockerfile/ansible-molecule/centos-7/-/raw/master/logo.png" />
    </a>
  </center>
</div>
<div align="center">
  <center><h1>CentOS 7 for Ansible Molecule</h1></center>
  <center><h4 style="color: #18c3d1;">A <a href="https://megabyte.space">Megabyte Labs</a> Dockerfile project / Latest build includes CentOS 7 v0.0.1</h4></center>
</div>
...
<div align="center">
  <h4 align="center">
    ...
    <a href="https://hub.docker.com/r/megabytelabs/centos-7" title="DockerHub page for this project" target="_blank">
      <img src="https://gitlab.com/megabyte-labs/assets/-/raw/master/svg/dockerhub-image-solid.svg" />
    </a>
    <a href="https://gitlab.com/megabyte-labs/dockerfile/ansible-molecule/centos-7/-/blob/master/CONTRIBUTING.md" title="Learn about contributing" target="_blank">
    ...
    <a href="https://github.com/ProfessorManhattan/docker-ansible-molecule-centos-7" title="GitHub mirror" target="_blank">
      <img src="https://gitlab.com/megabyte-labs/assets/-/raw/master/svg/github-solid.svg" />
    </a>
    <a href="https://gitlab.com/megabyte-labs/dockerfile/ansible-molecule/centos-7" title="GitLab repository" target="_blank">
      <img src="https://gitlab.com/megabyte-labs/assets/-/raw/master/svg/gitlab-solid.svg" />
    </a>
  </h4>
  <p align="center">
    <a href="https://hub.docker.com/repository/docker/megabytelabs/ansible-molecule-centos-7" target="_blank">
      <img alt="Version" src="https://img.shields.io/docker/v/megabytelabs/ansible-molecule-centos-7?logo=docker&logoColor=white&sort=date&style=flat" />
    </a>
    <a href="https://hub.docker.com/repository/docker/megabytelabs/ansible-molecule-centos-7" target="_blank">
      <img alt="DockerHub image size: CentOS 7" src="https://img.shields.io/docker/image-size/megabytelabs/ansible-molecule-centos-7?logo=docker&sort=date&logoColor=white&style=flat">
    </a>
    <a href="https://hub.docker.com/repository/docker/megabytelabs/ansible-molecule-centos-7" target="_blank">
      <img alt="DockerHub pulls: CentOS 7" src="https://img.shields.io/docker/pulls/megabytelabs/ansible-molecule-centos-7?logo=docker&logoColor=white&style=flat" />
    </a>
    <a href="https://hub.docker.com/repository/docker/megabytelabs/ansible-molecule-centos-7" target="_blank">
      <img alt="DockerHub stars: CentOS 7" src="https://img.shields.io/docker/stars/megabytelabs/ansible-molecule-centos-7?logo=docker&logoColor=white&style=flat" />
    </a>
    <a href="https://gitlab.com/megabyte-labs/dockerfile/ansible-molecule/centos-7/-/commits/master" target="_blank">
      <img alt="GitLab pipeline status" src="https://gitlab.com/megabyte-labs/dockerfile/ansible-molecule/centos-7/badges/master/pipeline.svg?style=flat" />
    </a>
    <a href="https://gitlab.com/megabyte-labs/dockerfile/ansible-molecule/centos-7/-/raw/master/LICENSE" target="_blank">
...
> </br><h3 align="center">**A CentOS 7 image with Python 3, systemd, and a non-root sudo user (user and password are both *ansible*) intended to be used by Ansible Molecule tests**</h3></br>
...
This project houses a Dockerfile and build tools that are meant to create an [Ansible Molecule](https://molecule.readthedocs.io/en/latest/)-compatible image for testing against CentOS 7. Ansible Molecule testing is an important part of creating Ansible roles. Nearly all of [our Ansible roles](https://gitlab.com/megabyte-labs/ansible-roles) support Archlinux, Debian, Fedora, CentOS, Ubuntu, Mac OS X, and Windows. On top of that, we have hundreds of roles to maintain. In order to alleviate the headache that comes with supporting so many operating systems and so many roles, we utilize several test methods which are all powered by Ansible Molecule. We use this project's image to test our Ansible scripts against CentOS 7 using Docker. Although you can use the image that this project creates on any CI platform, we choose to use GitLab CI because it is free. It allows us to spot bugs before the code is available publicly. Setting up GitLab CI with Ansible Molecule and Docker is a great first line of defense when it comes to preventing issues on Linux environments.
...
```shell
docker pull megabytelabs/centos-7:latest
```
...
```shell
docker run megabytelabs/centos-7:latest
docker exec -it megabytelabs/centos-7:latest /bin/bash
```
...
```shell
docker run -it --rm megabytelabs/centos-7:latest /bin/sh
```
...
docker build --pull -t "$DOCKERHUB_USERNAME/centos-7:latest" .
docker push "$DOCKERHUB_USERNAME/centos-7:latest"
```
...
Contributions, issues, and feature requests are welcome! Feel free to check the [issues page](https://gitlab.com/megabyte-labs/dockerfile/ansible-molecule/centos-7/-/issues). If you would like to contribute, please take a look at the [contributing guide](https://gitlab.com/megabyte-labs/dockerfile/ansible-molecule/centos-7/-/blob/master/CONTRIBUTING.md).
...
Copyright © 2021 [Megabyte LLC](https://megabyte.space). This project is [MIT](https://gitlab.com/megabyte-labs/dockerfile/ansible-molecule/centos-7/-/raw/master/LICENSE) licensed.
