...
> </br><h3 align="center">**A CentOS 8 image with Python 3, systemd, and a non-root sudo user (user and password are both _ansible_) intended to be used by Ansible Molecule tests**</h3></br>
