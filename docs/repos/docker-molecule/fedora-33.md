...
> </br><h3 align="center">**A Fedora 33 image with Python 3, systemd, and a non-root sudo user (user and password are both _ansible_) intended to be used by Ansible Molecule tests**</h3></br>
...
For more details, check out the [CONTRIBUTING.md](https://gitlab.com/megabyte-labs/dockerfile/ansible-molecule/fedora-33/-/blob/master/CONTRIBUTING.md) file.
