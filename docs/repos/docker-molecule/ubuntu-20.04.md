...
> </br><h3 align="center">**A Ubuntu 20.04 (i.e. Ubuntu Focal Fossa) image with Python 3, systemd, and a non-root sudo user (user and password are both _ansible_) intended to be used by Ansible Molecule tests**</h3></br>
