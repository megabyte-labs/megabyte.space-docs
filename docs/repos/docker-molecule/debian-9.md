...
> </br><h3 align="center">**A Debian 9 (i.e. Debian Stretch) image with Python 3, systemd, and a non-root sudo user (user and password are both *ansible*) intended to be used by Ansible Molecule tests**</h3></br>
