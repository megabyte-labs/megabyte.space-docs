...
title: Ansible Role
description: Provides a great, cross-platform starting point for developing an Ansible role
editUrl: <https://gitlab.com/megabyte-labs/templates/ansible-role/blob/master/docs/GUIDE.md>
editApiUrl: <https://github.com/ionic-team/capacitor-plugins/blob/main/templates/src/definitions.ts>
sidebar\_label: Ansible Role
githubUrl: 'https://github.com/megabyte-labs/template-ansible-role'
gitlabUrl: 'https://gitlab.com/megabyte-labs/templates/ansible-role'
ansibleGalaxyProjectId: false
packageGroup: 'ansible'
packageName: '@installdoc/template-ansible-role'
packageSlug: 'ansible-role'
packageVersion: '1.0.0'
pyPiPackageName: 'ansible-role'
-------------------------------
