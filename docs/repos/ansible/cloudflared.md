...
editUrl: <https://gitlab.com/megabyte-labs/ansible-roles/cloudflared/blob/master/docs/GUIDE.md>
editApiUrl: <https://github.com/ionic-team/capacitor-plugins/blob/main/ansible/src/definitions.ts>
sidebar\_label: CloudFlared
githubUrl: 'https://github.com/megabyte-labs/ansible-cloudflared'
gitlabUrl: 'https://gitlab.com/megabyte-labs/ansible-roles/cloudflared'
ansibleGalaxyProjectId: false
packageGroup: 'ansible'
packageName: '@installdoc/ansible-cloudflared'
packageSlug: 'cloudflared'
packageVersion: '1.0.0'
pyPiPackageName: 'cloudflared'
------------------------------
