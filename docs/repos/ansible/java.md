...
editUrl: <https://gitlab.com/megabyte-labs/ansible-roles/java/blob/master/docs/GUIDE.md>
editApiUrl: <https://github.com/ionic-team/capacitor-plugins/blob/main/ansible/src/definitions.ts>
sidebar\_label: Java
githubUrl: 'https://github.com/megabyte-labs/ansible-java'
gitlabUrl: 'https://gitlab.com/megabyte-labs/ansible-roles/java'
ansibleGalaxyProjectId: '57261'
packageGroup: 'ansible'
packageName: '@installdoc/ansible-java'
packageSlug: 'java'
packageVersion: '1.0.1'
pyPiPackageName: 'java'
-----------------------
