...
editUrl: <https://gitlab.com/megabyte-labs/ansible-roles/homebrew/blob/master/docs/GUIDE.md>
editApiUrl: <https://github.com/ionic-team/capacitor-plugins/blob/main/ansible/src/definitions.ts>
sidebar\_label: Homebrew
githubUrl: 'https://github.com/megabyte-labs/ansible-homebrew'
gitlabUrl: 'https://gitlab.com/megabyte-labs/ansible-roles/homebrew'
ansibleGalaxyProjectId: '57302'
packageGroup: 'ansible'
packageName: '@installdoc/ansible-homebrew'
packageSlug: 'homebrew'
packageVersion: '1.0.0'
pyPiPackageName: 'homebrew'
---------------------------
