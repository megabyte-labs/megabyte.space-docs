...
title: Dotfiles
description: Adds a sweet set of dotfiles to each of your home directories
editUrl: <https://gitlab.com/megabyte-labs/ansible-roles/dotfiles/blob/master/docs/GUIDE.md>
editApiUrl: <https://github.com/ionic-team/capacitor-plugins/blob/main/ansible/src/definitions.ts>
sidebar\_label: Dotfiles
githubUrl: 'https://github.com/megabyte-labs/ansible-dotfiles'
gitlabUrl: 'https://gitlab.com/megabyte-labs/ansible-roles/dotfiles'
ansibleGalaxyProjectId: false
packageGroup: 'ansible'
packageName: '@installdoc/ansible-dotfiles'
packageSlug: 'dotfiles'
packageVersion: '1.1.14'
pyPiPackageName: 'dotfiles'
---------------------------
