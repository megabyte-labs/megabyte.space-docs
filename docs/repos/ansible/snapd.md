...
editUrl: <https://gitlab.com/megabyte-labs/ansible-roles/snapd/blob/master/docs/GUIDE.md>
editApiUrl: <https://github.com/ionic-team/capacitor-plugins/blob/main/ansible/src/definitions.ts>
sidebar\_label: Snap
githubUrl: 'https://github.com/megabyte-labs/ansible-snapd'
gitlabUrl: 'https://gitlab.com/megabyte-labs/ansible-roles/snapd'
ansibleGalaxyProjectId: '56331'
packageGroup: 'ansible'
packageName: '@installdoc/ansible-snapd'
packageSlug: 'snapd'
packageVersion: '0.0.1'
pyPiPackageName: 'snapd'
------------------------
