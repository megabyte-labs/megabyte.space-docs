...
editUrl: <https://gitlab.com/megabyte-labs/ansible-roles/rust/blob/master/docs/GUIDE.md>
editApiUrl: <https://github.com/ionic-team/capacitor-plugins/blob/main/ansible/src/definitions.ts>
sidebar\_label: Rust
githubUrl: 'https://github.com/megabyte-labs/ansible-rust'
gitlabUrl: 'https://gitlab.com/megabyte-labs/ansible-roles/rust'
ansibleGalaxyProjectId: '57300'
packageGroup: 'ansible'
packageName: '@installdoc/ansible-rust'
packageSlug: 'rust'
packageVersion: '1.0.0'
pyPiPackageName: 'rust'
-----------------------
