...
title: Betelgeuse Theme
description: Installs the Betelgeuse Linux theme which styles a wide variety of display managers (among other things)
editUrl: <https://gitlab.com/megabyte-labs/ansible-roles/theme/blob/master/docs/GUIDE.md>
editApiUrl: <https://github.com/ionic-team/capacitor-plugins/blob/main/ansible/src/definitions.ts>
sidebar\_label: Betelgeuse Theme
githubUrl: 'https://github.com/megabyte-labs/ansible-theme'
gitlabUrl: 'https://gitlab.com/megabyte-labs/ansible-roles/theme'
ansibleGalaxyProjectId: false
packageGroup: 'ansible'
packageName: '@installdoc/ansible-theme'
packageSlug: 'theme'
packageVersion: '1.1.14'
pyPiPackageName: 'theme'
------------------------
...
| ------------------------------- | ------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| theme\_slug                      | `""`          | The slug / folder name of the theme                                                                                                                                                                                                                                                                                                                                                                                        |
