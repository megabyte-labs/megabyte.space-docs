...
editUrl: <https://gitlab.com/megabyte-labs/ansible-roles/nordvpn/blob/master/docs/GUIDE.md>
editApiUrl: <https://github.com/ionic-team/capacitor-plugins/blob/main/ansible/src/definitions.ts>
sidebar\_label: NordVPN
githubUrl: 'https://github.com/megabyte-labs/ansible-nordvpn'
gitlabUrl: 'https://gitlab.com/megabyte-labs/ansible-roles/nordvpn'
ansibleGalaxyProjectId: false
packageGroup: 'ansible'
packageName: '@installdoc/ansible-nordvpn'
packageSlug: 'nordvpn'
packageVersion: '1.0.0'
pyPiPackageName: 'nordvpn'
--------------------------
