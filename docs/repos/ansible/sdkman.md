...
editUrl: <https://gitlab.com/megabyte-labs/ansible-roles/sdkman/blob/master/docs/GUIDE.md>
editApiUrl: <https://github.com/ionic-team/capacitor-plugins/blob/main/ansible/src/definitions.ts>
sidebar\_label: SDKMAN
githubUrl: 'https://github.com/megabyte-labs/ansible-sdkman'
gitlabUrl: 'https://gitlab.com/megabyte-labs/ansible-roles/sdkman'
ansibleGalaxyProjectId: '57598'
packageGroup: 'ansible'
packageName: '@installdoc/ansible-sdkman'
packageSlug: 'sdkman'
packageVersion: '1.0.0'
pyPiPackageName: 'sdkman'
-------------------------

<div align="center">
  <center>
    <a href="https://github.com/megabyte-labs/ansible-sdkman">
      <img width="148" height="148" alt="SDKMAN logo" src="https://gitlab.com/megabyte-labs/ansible-roles/sdkman/-/raw/master/logo.png" />
    </a>
  </center>
</div>
<div align="center">
  <center><h1 align="center"><i></i>SDKMAN<i></i></h1></center>
...
<div align="center">
  ...
  <a href="https://github.com/megabyte-labs/ansible-sdkman/blob/master/docs/CONTRIBUTING.md" title="Learn about contributing" target="_blank">
  ...
  <a href="https://github.com/megabyte-labs/ansible-sdkman" title="GitHub mirror" target="_blank">
    <img alt="GitHub" src="https://img.shields.io/badge/Mirror-GitHub-333333?logo=github&style=for-the-badge" />
  </a>
  <a href="https://gitlab.com/megabyte-labs/ansible-roles/sdkman" title="GitLab repository" target="_blank">
    <img alt="GitLab" src="https://img.shields.io/badge/Repo-GitLab-fc6d26?logo=data:image/png;base64,&style=for-the-badge" />
  </a>
</div>
<br/>
<div align="center">
  <a title="Ansible Galaxy role: professormanhattan.sdkman" href="https://galaxy.ansible.com/professormanhattan/sdkman" target="_blank">
    <img alt="Ansible Galaxy role: professormanhattan.sdkman" src="https://img.shields.io/ansible/role/57598?logo=ansible&style=flat-square" />
  </a>
  <a title="Version: 1.0.0" href="https://github.com/megabyte-labs/ansible-sdkman" target="_blank">
  ...
  <a title="GitLab build status" href="https://gitlab.com/megabyte-labs/ansible-roles/sdkman/-/commits/master" target="_blank">
    <img alt="Build status" src="https://img.shields.io/gitlab/pipeline-status/megabyte-labs/ansible-roles/sdkman?branch=master&label=build&logo=gitlab&logoColor=white&style=flat-square" />
  </a>
  <a title="Windows 11 test status on GitHub" href="https://github.com/megabyte-labs/ansible-sdkman/actions/workflows/Windows.yml" target="_blank">
    <img alt="Windows 11 test status" src="https://img.shields.io/github/workflow/status/ProfessorManhattan/ansible-sdkman/Windows%20Ansible%20Role%20Test/master?color=cyan&label=windows&logo=windows&style=flat-square" />
  </a>
  <a title="macOS test status on GitLab" href="https://gitlab.com/megabyte-labs/ansible-roles/sdkman/-/commits/master" target="_blank">
    <img alt="macOS test status" src="https://img.shields.io/gitlab/pipeline-status/megabyte-labs/ansible-roles/sdkman?branch=test%2Fdarwin&label=osx&logo=apple&style=flat-square" />
  </a>
  <a title="Linux Molecule test status on GitLab" href="https://gitlab.com/megabyte-labs/ansible-roles/sdkman/-/commits/master" target="_blank">
    <img alt="Linux Molecule test status" src="https://img.shields.io/gitlab/pipeline-status/megabyte-labs/ansible-roles/sdkman?branch=test%2Flinux&label=linux&logo=data:image/png;base64,&style=flat-square" />
  </a>
  <a title="Ansible Galaxy quality score (out of 5)" href="https://galaxy.ansible.com/professormanhattan/sdkman" target="_blank">
    <img alt="Ansible Galaxy quality score" src="https://img.shields.io/ansible/quality/57598?logo=ansible&style=flat-square" />
  </a>
  <a title="Ansible Galaxy download count" href="https://galaxy.ansible.com/professormanhattan/sdkman" target="_blank">
    <img alt="Ansible Galaxy download count" src="https://img.shields.io/ansible/role/d/57598?logo=ansible&label=downloads&style=flat-square" />
  </a>
  <a title="Documentation" href="https://megabyte.space/docs/ansible" target="_blank">
    <img alt="Documentation" src="https://img.shields.io/badge/documentation-yes-brightgreen.svg?logo=readthedocs&logoColor=white&style=flat-square" />
  </a>
  <a title="License: MIT" href="https://github.com/megabyte-labs/ansible-sdkman/blob/master/LICENSE" target="_blank">
...
* Ensures SDKMAN is installed on macOS and Linux systems
...
Looking to install SDKMAN without having to deal with [Ansible](https://www.ansible.com/)? Simply run the following command that correlates to your operating system:

**Linux/macOS:**

```shell
curl -sS https://install.doctor/sdkman | bash
```

**Windows:**

```powershell
Set-ExecutionPolicy Bypass -Scope Process -Force; [System.Net.ServicePointManager]::SecurityProtocol = [System.Net.ServicePointManager]::SecurityProtocol -bor 3072; iex ((New-Object System.Net.WebClient).DownloadString('https://install.doctor/sdkman?os=win'))
```
...
| ------------------------------- | ------------- | ---------------------------------------------- |
| [`sdk_installs`](#sdk_installs) | `[]`          | List of one or more versions of SDK to install |
| [`user_configs`](#user_configs) | `[]`          | List of users to run the setup for             |
...
```yaml
#💬 Example implementation of the sdk_installs variable
sdk_installs:
  - java 8u11
  - scala 2.11.6
```
...
| ------------- | --------------------- | ---------------------------- | ---------------------------- | ----------------- |
| ArchLinux     | Latest                | <div align="center">✅</div> | <div align="center">✅</div> | January 6th, 2022 |
| CentOS        | 7                     | <div align="center">✅</div> | <div align="center">✅</div> | January 6th, 2022 |
| CentOS        | 8                     | <div align="center">✅</div> | <div align="center">✅</div> | January 6th, 2022 |
| CentOS Stream | 8                     | <div align="center">✅</div> | <div align="center">✅</div> | January 6th, 2022 |
| Debian        | 10 (Buster)           | <div align="center">✅</div> | <div align="center">✅</div> | January 6th, 2022 |
| Debian        | 11 (Bullseye)         | <div align="center">✅</div> | <div align="center">✅</div> | January 6th, 2022 |
| Debian        | 9 (Stretch)           | <div align="center">✅</div> | <div align="center">✅</div> | January 6th, 2022 |
| Fedora        | 33                    | <div align="center">✅</div> | <div align="center">✅</div> | January 6th, 2022 |
| Fedora        | 34                    | <div align="center">✅</div> | <div align="center">✅</div> | January 6th, 2022 |
| Fedora        | 35                    | <div align="center">✅</div> | <div align="center">✅</div> | January 6th, 2022 |
| Ubuntu        | 18.04 (Bionic Beaver) | <div align="center">✅</div> | <div align="center">✅</div> | January 6th, 2022 |
| Ubuntu        | 20.04 (Focal Fossa)   | <div align="center">✅</div> | <div align="center">✅</div> | January 6th, 2022 |
| Ubuntu        | 21.04 (Hirsute Hippo) | <div align="center">✅</div> | <div align="center">✅</div> | January 6th, 2022 |
| Ubuntu        | 21.10 (Impish Indri)  | <div align="center">✅</div> | <div align="center">✅</div> | January 6th, 2022 |
| Windows       | 10                    | <div align="center">✅</div> | <div align="center">✅</div> | January 6th, 2022 |
...
Contributions, issues, and feature requests are welcome! Feel free to check the [issues page](https://github.com/megabyte-labs/ansible-sdkman/issues). If you would like to contribute, please take a look at the [contributing guide](https://github.com/megabyte-labs/ansible-sdkman/blob/master/docs/CONTRIBUTING.md).
...
Copyright © 2020-2021 [Megabyte LLC](https://megabyte.space). This project is [MIT](https://gitlab.com/megabyte-labs/ansible-roles/sdkman/-/blob/master/LICENSE) licensed.
