...
editUrl: <https://gitlab.com/megabyte-labs/ansible-roles/bravebrowser/blob/master/docs/GUIDE.md>
editApiUrl: <https://github.com/ionic-team/capacitor-plugins/blob/main/ansible/src/definitions.ts>
sidebar\_label: Brave Browser
githubUrl: 'https://github.com/megabyte-labs/ansible-bravebrowser'
gitlabUrl: 'https://gitlab.com/megabyte-labs/ansible-roles/bravebrowser'
ansibleGalaxyProjectId: '58360'
packageGroup: 'ansible'
packageName: '@installdoc/ansible-bravebrowser'
packageSlug: 'bravebrowser'
packageVersion: '1.0.0'
pyPiPackageName: 'bravebrowser'
-------------------------------
