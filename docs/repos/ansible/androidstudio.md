...
editUrl: <https://gitlab.com/megabyte-labs/ansible-roles/androidstudio/blob/master/docs/GUIDE.md>
editApiUrl: <https://github.com/ionic-team/capacitor-plugins/blob/main/ansible/src/definitions.ts>
sidebar\_label: Android Studio
githubUrl: 'https://github.com/megabyte-labs/ansible-androidstudio'
gitlabUrl: 'https://gitlab.com/megabyte-labs/ansible-roles/androidstudio'
ansibleGalaxyProjectId: '56329'
packageGroup: 'ansible'
packageName: '@installdoc/ansible-androidstudio'
packageSlug: 'androidstudio'
packageVersion: '1.2.0'
pyPiPackageName: 'androidstudio'
--------------------------------
