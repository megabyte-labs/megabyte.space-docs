...
editUrl: <https://gitlab.com/megabyte-labs/packer/centos-desktop/blob/master/docs/GUIDE.md>
editApiUrl: <https://github.com/ionic-team/capacitor-plugins/blob/main/packer/src/definitions.ts>
sidebar\_label: CentOS Stream Desktop
githubUrl: 'https://github.com/megabyte-labs/packer-centos-desktop'
gitlabUrl: 'https://gitlab.com/megabyte-labs/packer/centos-desktop'
ansibleGalaxyProjectId: false
packageGroup: 'packer'
packageName: '@mblabs/centos-desktop'
packageSlug: 'centos-desktop'
packageVersion: '1.0.0'
pyPiPackageName: 'centos-desktop'
---------------------------------

<div align="center">
  <center>
    <a href="https://github.com/megabyte-labs/packer-centos-desktop">
      <img width="148" height="148" alt="CentOS Stream Desktop logo" src="https://gitlab.com/megabyte-labs/packer/centos-desktop/-/raw/master/logo.png" />
    </a>
  </center>
</div>
<div align="center">
  <center><h1 align="center"><i></i>CentOS Stream Desktop Template for Packer<i></i></h1></center>
...
<div align="center">
  ...
  <a href="https://github.com/megabyte-labs/packer-centos-desktop/blob/master/docs/CONTRIBUTING.md" title="Learn about contributing" target="_blank">
  ...
  <a href="https://github.com/megabyte-labs/packer-centos-desktop" title="GitHub mirror" target="_blank">
...
<br/>
<div align="center">
  <a title="Version: 1.0.0" href="https://github.com/megabyte-labs/packer-centos-desktop" target="_blank">
  ...
  <a title="Pipeline status" href="https://gitlab.com/megabyte-labs/packer/centos-desktop/-/commits/master" target="_blank">
    <img alt="Pipeline status" src="https://img.shields.io/gitlab/pipeline-status/megabyte-labs/packer/centos-desktop?branch=master&label=build&logo=gitlab&style=flat-square" />
  </a>
  <a title="Hyper-V build status" href="https://gitlab.com/megabyte-labs/packer/centos-desktop/-/commits/master" target="_blank">
    <img alt="Hyper-V build status" src="https://img.shields.io/gitlab/pipeline-status/megabyte-labs/packer/centos-desktop?branch=hyperv&label=build&logo=hyper&style=flat-square" />
  </a>
  <a title="KVM/QEMU build status" href="https://gitlab.com/megabyte-labs/packer/centos-desktop/-/commits/master" target="_blank">
    <img alt="KVM/QEMU build status" src="https://img.shields.io/gitlab/pipeline-status/megabyte-labs/packer/centos-desktop?branch=qemu&label=build&logo=qemu&style=flat-square" />
  </a>
  <a title="Parallels build status" href="https://gitlab.com/megabyte-labs/packer/centos-desktop/-/commits/master" target="_blank">
    <img alt="Parallels build status" src="https://img.shields.io/gitlab/pipeline-status/megabyte-labs/packer/centos-desktop?branch=parallels&label=build&logo=macos&style=flat-square" />
  </a>
  <a title="VirtualBox build status" href="https://gitlab.com/megabyte-labs/packer/centos-desktop/-/commits/master" target="_blank">
    <img alt="VirtualBox build status" src="https://img.shields.io/gitlab/pipeline-status/megabyte-labs/packer/centos-desktop?branch=virtualbox&label=build&logo=virtualbox&style=flat-square" />
  </a>
  <a title="VMWare build status" href="https://gitlab.com/megabyte-labs/packer/centos-desktop/-/commits/master" target="_blank">
    <img alt="VMWare build status" src="https://img.shields.io/gitlab/pipeline-status/megabyte-labs/packer/centos-desktop?branch=vmware&label=build&logo=vmware&style=flat-square" />
  </a>
  ...
  <a title="License: MIT" href="https://github.com/megabyte-labs/packer-centos-desktop/blob/master/LICENSE" target="_blank">
...
Contributions, issues, and feature requests are welcome! Feel free to check the [issues page](https://github.com/megabyte-labs/packer-centos-desktop/issues). If you would like to contribute, please take a look at the [contributing guide](https://github.com/megabyte-labs/packer-centos-desktop/blob/master/docs/CONTRIBUTING.md).
...
Copyright © 2020-2021 [Megabyte LLC](https://megabyte.space). This project is [MIT](https://gitlab.com/megabyte-labs/packer/centos-desktop/-/blob/master/LICENSE) licensed.
