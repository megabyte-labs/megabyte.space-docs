...
title: macOS Desktop
description: An automated macOS Monterey Desktop Packer project that builds boxes using the latest Monterey sources
editUrl: <https://gitlab.com/megabyte-labs/packer/macos-desktop/blob/master/docs/GUIDE.md>
editApiUrl: <https://github.com/ionic-team/capacitor-plugins/blob/main/packer/src/definitions.ts>
sidebar\_label: macOS Desktop
githubUrl: 'https://github.com/megabyte-labs/packer-macos-desktop'
gitlabUrl: 'https://gitlab.com/megabyte-labs/packer/macos-desktop'
ansibleGalaxyProjectId: false
packageGroup: 'packer'
packageName: '@mblabs/macos-desktop'
packageSlug: 'macos-desktop'
packageVersion: '1.0.0'
pyPiPackageName: 'macos-desktop'
--------------------------------
