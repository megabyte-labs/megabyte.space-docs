...
editUrl: <https://gitlab.com/megabyte-labs/packer/windows-desktop/blob/master/docs/GUIDE.md>
editApiUrl: <https://github.com/ionic-team/capacitor-plugins/blob/main/packer/src/definitions.ts>
sidebar\_label: Windows 11 Desktop
githubUrl: 'https://github.com/megabyte-labs/packer-windows-desktop'
gitlabUrl: 'https://gitlab.com/megabyte-labs/packer/windows-desktop'
ansibleGalaxyProjectId: false
packageGroup: 'packer'
packageName: '@mblabs/windows-desktop'
packageSlug: 'windows-desktop'
packageVersion: '1.0.0'
pyPiPackageName: 'windows-desktop'
----------------------------------
