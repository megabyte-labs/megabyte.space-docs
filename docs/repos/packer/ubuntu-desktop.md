...
description: An automated Ubuntu Desktop Packer project (currently, version 22.04) that builds boxes using the latest Ubuntu Desktop Live release
editUrl: <https://gitlab.com/megabyte-labs/packer/ubuntu-desktop/blob/master/docs/GUIDE.md>
editApiUrl: <https://github.com/ionic-team/capacitor-plugins/blob/main/packer/src/definitions.ts>
sidebar\_label: Ubuntu Desktop
githubUrl: 'https://github.com/megabyte-labs/packer-ubuntu-desktop'
gitlabUrl: 'https://gitlab.com/megabyte-labs/packer/ubuntu-desktop'
ansibleGalaxyProjectId: false
packageGroup: 'packer'
packageName: '@mblabs/ubuntu-desktop'
packageSlug: 'ubuntu-desktop'
packageVersion: '1.0.0'
pyPiPackageName: 'ubuntu-desktop'
---------------------------------
