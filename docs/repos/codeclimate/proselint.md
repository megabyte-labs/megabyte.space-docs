...
title: Proselint
description: A slim Proselint standalone linter / CodeClimate engine for GitLab CI
editUrl: <https://gitlab.com/megabyte-labs/docker/codeclimate/proselint/blob/master/docs/GUIDE.md>
editApiUrl: <https://github.com/ionic-team/capacitor-plugins/blob/main/codeclimate/src/definitions.ts>
sidebar\_label: Proselint
githubUrl: 'https://github.com/megabyte-labs/codeclimate-proselint'
gitlabUrl: 'https://gitlab.com/megabyte-labs/docker/codeclimate/proselint'
ansibleGalaxyProjectId: false
packageGroup: 'docker'
packageName: '@megabytelabs/codeclimate-proselint'
packageSlug: 'proselint'
packageVersion: '0.13.0'
pyPiPackageName: 'proselint'
----------------------------
...
*Note:* The DockerHub page for the CodeClimate engine version of this project is located on the aforementioned DockerHub page and also on a [separate DockerHub page](https://hub.docker.com/r/megabytelabs/codeclimate-proselint) prefixed with `codeclimate-`.
