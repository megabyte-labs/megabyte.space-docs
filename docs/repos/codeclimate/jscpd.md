...
title: jscpd
description: A slim jscpd standalone linter / CodeClimate engine for GitLab CI
editUrl: <https://gitlab.com/megabyte-labs/docker/codeclimate/jscpd/blob/master/docs/GUIDE.md>
editApiUrl: <https://github.com/ionic-team/capacitor-plugins/blob/main/codeclimate/src/definitions.ts>
sidebar\_label: jscpd
githubUrl: 'https://github.com/megabyte-labs/codeclimate-jscpd'
gitlabUrl: 'https://gitlab.com/megabyte-labs/docker/codeclimate/jscpd'
ansibleGalaxyProjectId: false
packageGroup: 'docker'
packageName: '@megabytelabs/codeclimate-jscpd'
packageSlug: 'jscpd'
packageVersion: '3.5.1'
pyPiPackageName: 'jscpd'
------------------------
...
*Note:* The DockerHub page for the CodeClimate engine version of this project is located on the aforementioned DockerHub page and also on a [separate DockerHub page](https://hub.docker.com/r/megabytelabs/codeclimate-jscpd) prefixed with `codeclimate-`.
