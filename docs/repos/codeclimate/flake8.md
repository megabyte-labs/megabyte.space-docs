...
title: Flake8
description: A slim Flake8 and a CodeClimate engine container for GitLab CI
editUrl: <https://gitlab.com/megabyte-labs/docker/codeclimate/flake8/blob/master/docs/GUIDE.md>
editApiUrl: <https://github.com/ionic-team/capacitor-plugins/blob/main/codeclimate/src/definitions.ts>
sidebar\_label: Flake8
githubUrl: 'https://github.com/megabyte-labs/codeclimate-flake8'
gitlabUrl: 'https://gitlab.com/megabyte-labs/docker/codeclimate/flake8'
ansibleGalaxyProjectId: false
packageGroup: 'docker'
packageName: '@megabytelabs/codeclimate-flake8'
packageSlug: 'flake8'
packageVersion: '1.0.2'
pyPiPackageName: 'flake8'
-------------------------

<div align="center">
  <center>
    <a href="https://github.com/megabyte-labs/codeclimate-flake8">
...
<div align="center">
  <center><h1 align="center"><i></i>Flake8 CodeClimate Engine<i></i></h1></center>
...
<div align="center">
  ...
  <a href="https://github.com/megabyte-labs/codeclimate-flake8/blob/master/docs/CONTRIBUTING.md" title="Learn about contributing" target="_blank">
  ...
  <a href="https://github.com/megabyte-labs/codeclimate-flake8" title="GitHub mirror" target="_blank">
    <img alt="GitHub" src="https://img.shields.io/badge/Mirror-GitHub-333333?logo=github&style=for-the-badge" />
  </a>
  <a href="https://gitlab.com/megabyte-labs/docker/codeclimate/flake8" title="GitLab repository" target="_blank">
    <img alt="GitLab" src="https://img.shields.io/badge/Repo-GitLab-fc6d26?logo=data:image/png;base64,&style=for-the-badge" />
  </a>
</div>
<br/>
<div align="center">
  <a title="Version: 1.0.2" href="https://github.com/megabyte-labs/codeclimate-flake8" target="_blank">
  ...
  <a title="DockerHub image size" href="https://hub.docker.com/repository/docker/megabytelabs/flake8" target="_blank">
    <img alt="Image size" src="https://img.shields.io/docker/image-size/megabytelabs/flake8?logo=docker&sort=date&logoColor=white&style=flat-square" />
  </a>
  <a title="DockerHub pulls" href="https://hub.docker.com/repository/docker/megabytelabs/flake8" target="_blank">
    <img alt="Pulls" src="https://img.shields.io/docker/pulls/megabytelabs/flake8?logo=docker&logoColor=white&style=flat-square" />
  </a>
  <a title="DockerHub stars" href="https://hub.docker.com/repository/docker/megabytelabs/flake8" target="_blank">
    <img alt="Stars" src="https://img.shields.io/docker/stars/megabytelabs/flake8?logo=docker&logoColor=white&style=flat-square" />
  </a>
  <a title="Documentation" href="https://megabyte.space/docs/docker" target="_blank">
    <img alt="Documentation" src="https://img.shields.io/badge/documentation-yes-brightgreen.svg?logo=readthedocs&logoColor=white&style=flat-square" />
  </a>
  <a title="License: MIT" href="https://github.com/megabyte-labs/codeclimate-flake8/blob/master/LICENSE" target="_blank">
    <img alt="License: MIT" src="https://img.shields.io/badge/license-MIT-yellow.svg?logo=data:image/png;base64,&style=flat-square" />
  </a>
</div>

> <br/><h4 align="center">**A slim Flake8 and a CodeClimate engine container for GitLab CI**</h4><br/>
...
* [Extending Flake8](#extending-flake8)
...
This project is the home of a **[Flake8](https://flake8.pycqa.org/en/latest/)** [CodeClimate](https://codeclimate.com/) engine. It was built to integrate Flake8 results into the GitLab merge request web UI. This project also generates a standalone, slim instance of Flake8 that you can use to quickly run Flake8 in a CI/CD pipeline.
...
Flake8 is also extendable with plugins. You can find a wealth of Flake8 plugins on the [Awesome Flake8 page on GitHub](https://github.com/DmytroLitvinov/awesome-flake8-extensions).

### Standalone

If you are interested in using the tool and have no need for CodeClimate integration, you can get the `latest`, `slim`, and versioned images without CodeClimate-related code by removing the `codeclimate-` string from the image name. For example, if the image is named `megabytelabs/codeclimate-flake8`, then you can get the same image without CodeClimate-related code by using the `megabytelabs/flake8` image. For a full listing of images to choose from, check out the [DockerHub page for this project](https://hub.docker.com/r/megabytelabs/flake8).

*Note:* The DockerHub page for the CodeClimate engine version of this project is located on the aforementioned DockerHub page and also on a [separate DockerHub page](https://hub.docker.com/r/megabytelabs/codeclimate-flake8) prefixed with `codeclimate-`.
...
```shell
flake8() {
  docker run -it -v ${PWD}:/work -w /work --rm megabytelabs/flake8:latest "$@"
}
```
...
```shell
docker pull megabytelabs/codeclimate-flake8:latest
docker tag megabytelabs/codeclimate-flake8:latest codeclimate/codeclimate-flake8:latest
```
...
<a href="#extending-flake8" style="width:100%"><img style="width:100%" src="https://gitlab.com/megabyte-labs/assets/-/raw/master/png/aqua-divider.png" /></a>
...
docker build --pull -t "$DOCKERHUB_USERNAME/flake8:latest" .
docker push "$DOCKERHUB_USERNAME/flake8:latest"
```
...
export DOCKERHUB_PASSWORD=Your_DockerHub_Password_Here
docker login -u "$DOCKERHUB_USERNAME" -p "$DOCKERHUB_PASSWORD" docker.io
docker build -t "$DOCKERHUB_USERNAME/flake8:latest" .
docker-slim build --tag $DOCKERHUB_USERNAME/flake8:slim {{#if (eq (typeOf dockerSlimCommand) "string")}}dockerSlimCommand}}{{/if{{#if (not (eq (typeOf dockerSlimCommand) "string"))}}dockerSlimCommand[slug]}}{{/if $DOCKERHUB_USERNAME/flake8:latest
docker push "$DOCKERHUB_USERNAME/flake8:slim"
```
...
If you come up with an improvement, please do [open a pull request](repository.group.dockerCodeClimate/flake8/-/issues/new). And again, make sure you replace `DOCKERHUB_USERNAME` and `DOCKERHUB_PASSWORD` in the snippet above with your Docker Hub username and password. The commands in the snippet above will build the slim Docker image and upload it to [Docker Hub](https://hub.docker.com/) where it will be publicly accessible.
...
For more details, check out the [CONTRIBUTING.md](https://gitlab.com/megabyte-labs/docker/codeclimate/flake8/-/blob/master/CONTRIBUTING.md) file.
...
Contributions, issues, and feature requests are welcome! Feel free to check the [issues page](https://github.com/megabyte-labs/codeclimate-flake8/issues). If you would like to contribute, please take a look at the [contributing guide](https://github.com/megabyte-labs/codeclimate-flake8/blob/master/docs/CONTRIBUTING.md).
...
Copyright © 2020-2021 [Megabyte LLC](https://megabyte.space). This project is [MIT](https://gitlab.com/megabyte-labs/docker/codeclimate/flake8/-/blob/master/LICENSE) licensed.
