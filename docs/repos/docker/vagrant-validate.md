...
editUrl: https://gitlab.com/megabyte-labs/docker/ci-pipeline/vagrant-validate/blob/master/docs/GUIDE.md
...
packageGroup: false
packageName: '@megabytelabs/vagrant'
packageSlug: false
packageVersion: '2.2.16'
pyPiPackageName: false
---

<div align="center">
  <center>
    <a href="https://gitlab.com/megabyte-labs/dockerfile/ci-pipeline/vagrant">
      <img width="140" height="140" alt="Vagrant Validate logo" src="https://gitlab.com/megabyte-labs/dockerfile/ci-pipeline/vagrant/-/raw/master/logo.png" />
    </a>
  </center>
</div>
<div align="center">
  <center><h1>Vagrant Validate - A Vagrant Container</h1></center>
  <center><h4 style="color: #18c3d1;">A <a href="https://megabyte.space">Megabyte Labs</a> Dockerfile project / Latest build includes Vagrant Validate v2.2.16</h4></center>
</div>
...
<div align="center">
  <h4 align="center">
    ...
    <a href="https://hub.docker.com/r/megabytelabs/vagrant" title="DockerHub page for this project" target="_blank">
      <img src="https://gitlab.com/megabyte-labs/assets/-/raw/master/svg/dockerhub-image-solid.svg" />
    </a>
    <a href="https://gitlab.com/megabyte-labs/dockerfile/ci-pipeline/vagrant/-/blob/master/CONTRIBUTING.md" title="Learn about contributing" target="_blank">
    ...
    <a href="https://github.com/ProfessorManhattan/docker-vagrant" title="GitHub mirror" target="_blank">
      <img src="https://gitlab.com/megabyte-labs/assets/-/raw/master/svg/github-solid.svg" />
    </a>
    <a href="https://gitlab.com/megabyte-labs/dockerfile/ci-pipeline/vagrant" title="GitLab repository" target="_blank">
      <img src="https://gitlab.com/megabyte-labs/assets/-/raw/master/svg/gitlab-solid.svg" />
    </a>
  </h4>
  <p align="center">
    <a href="https://hub.docker.com/repository/docker/megabytelabs/vagrant" target="_blank">
      <img alt="Version" src="https://img.shields.io/docker/v/megabytelabs/vagrant?logo=docker&logoColor=white&sort=date&style=flat" />
    </a>
    <a href="https://hub.docker.com/repository/docker/megabytelabs/vagrant" target="_blank">
      <img alt="DockerHub image size: Vagrant Validate" src="https://img.shields.io/docker/image-size/megabytelabs/vagrant?logo=docker&sort=date&logoColor=white&style=flat">
    </a>
    <a href="https://hub.docker.com/repository/docker/megabytelabs/vagrant" target="_blank">
      <img alt="DockerHub pulls: Vagrant Validate" src="https://img.shields.io/docker/pulls/megabytelabs/vagrant?logo=docker&logoColor=white&style=flat" />
    </a>
    <a href="https://hub.docker.com/repository/docker/megabytelabs/vagrant" target="_blank">
      <img alt="DockerHub stars: Vagrant Validate" src="https://img.shields.io/docker/stars/megabytelabs/vagrant?logo=docker&logoColor=white&style=flat" />
    </a>
    <a href="https://gitlab.com/megabyte-labs/dockerfile/ci-pipeline/vagrant/-/commits/master" target="_blank">
      <img alt="GitLab pipeline status" src="https://gitlab.com/megabyte-labs/dockerfile/ci-pipeline/vagrant/badges/master/pipeline.svg?style=flat" />
    </a>
    <a href="https://gitlab.com/megabyte-labs/dockerfile/ci-pipeline/vagrant/-/raw/master/LICENSE" target="_blank">
...
```shell
docker run -v ${PWD}:/work -w /work megabytelabs/vagrant:slim validate
```

This allows you to run Vagrant Validate without installing it locally. This could be good for security since the application is within a container and also keeps your file system clean.

You can also add a bash alias to your `~/.bashrc` file so that you can run the Vagrant Validate command at any time. To do this, add the following snippet to your `~/.bashrc` file (or `~/.bash_profile` if you are on macOS):

```shell
docker-vagrant() {
  docker run -v ${PWD}:/work -w /work megabytelabs/vagrant:slim "$@"
}
```
...
docker build --pull -t "$DOCKERHUB_USERNAME/vagrant:latest" .
docker push "$DOCKERHUB_USERNAME/vagrant:latest"
```
...
For more details, check out the [CONTRIBUTING.md](https://gitlab.com/megabyte-labs/dockerfile/ci-pipeline/vagrant/-/blob/master/CONTRIBUTING.md) file.

[![-----------------------------------------------------](https://raw.githubusercontent.com/andreasbm/readme/master/assets/lines/aqua.png)](#contributing)

## ➤ Contributing

Contributions, issues, and feature requests are welcome! Feel free to check the [issues page](https://gitlab.com/megabyte-labs/dockerfile/ci-pipeline/vagrant/-/issues). If you would like to contribute, please take a look at the [contributing guide](https://gitlab.com/megabyte-labs/dockerfile/ci-pipeline/vagrant/-/blob/master/CONTRIBUTING.md).
...
Copyright © 2021 [Megabyte LLC](https://megabyte.space). This project is [MIT](https://gitlab.com/megabyte-labs/dockerfile/ci-pipeline/vagrant/-/raw/master/LICENSE) licensed.